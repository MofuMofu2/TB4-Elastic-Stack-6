...
@<chapref>{beats}でも触れていますが、専用の@<code>{Beats Modules}を起動すると、Elasticsearchに自動で接続・KibanaのDashboardまで作成できます。
とても便利ですね。
...
ちなみにKibana5.4から増えたグラフは次の通りです。なんで5.4からかだって？もふちゃんが知ってるの、それが最後なの！しょうがないでしょ同人誌書くときしか使わないんだから！
...
その中でも異彩を放つ@<code>{Vega}についてここでは取り上げたいと思います。
...
閲覧しやすいかな〜などと迷っているときに、毎回グラフを作成し直すのは不便です。
...
もふちゃんも気遣いができるすばらしい大人目指してやっていきたいと思います。
