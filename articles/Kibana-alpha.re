...
この細胞、赤・青・緑を感じることができる物質をそれぞれ持っています。赤・青・緑の濃さを見分けて、色を見分けることができるのです。
...
Elasticsearch社はこの色盲の方に配慮してUIの色を変更したのです。
...
「じゃあもうVisualizeする必要はないのかな？」と思った方もいるかもしれません。ただこのModules、利用できるデータの種類に制限があります。
...
Webサービスは性能が命ですから、性能やサービス監視の構築に手間をかけたくはありません。Modulesを利用すれば、監視環境の構築コストを下げることができます。
...
このグラフはベータ版なので開発が中止される可能性があります。よって、本番環境でVegaを利用することは推奨できません。


== 何気に嬉しい便利機能

これから紹介する機能を知っていると、よりKibanaを便利に利用できるかもしれません。
...
しかし、検索窓に例が記述されていれば何かしらの検索はすぐできますよね。これはとてもありがたいことです。この細やかで目立たないけれど利便性を上げる努力から、Elasticsearch社が
